...
Check out [React Bootstrap Select Dropdown Documentation](https://mdbootstrap.com/docs/react/extended/select-dropdown/) for detailed instructions & even more examples.
